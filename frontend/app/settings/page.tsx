...
export default function SettingsPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 pb-12 select-none items-start w-full">
      ...
      {/* 2. Main content area: form + help guidelines stacked or side-by-side */}
      <div className="flex-grow w-full flex flex-col xl:flex-row gap-6 items-start min-w-0">
        {/* Center Configuration form panel */}
        <div className="flex-grow w-full max-w-2xl min-w-0">
